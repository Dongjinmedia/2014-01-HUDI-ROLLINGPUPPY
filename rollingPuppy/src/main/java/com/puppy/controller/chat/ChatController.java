...
public class ChatController implements Controller {
	...
	private void updateChattingRoomFoldTime(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			int currentChatRoomNumber = ServletRequestUtils.getIntParameterFromPart(request, Constants.REQUEST_CHATROOM_NUMBER); 
