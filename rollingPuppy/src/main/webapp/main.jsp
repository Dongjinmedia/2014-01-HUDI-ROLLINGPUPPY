...
<!--네비게이션바 영역 -->
			<nav id = "menu_navigation">
				<ul class = "nav_list">
					<li> <a href = "#" class = "search">검색</a>
    				</li>
					<li> <a href = "#" class = "recommendation">추천방</a>
    				</li>
					<li> <a href = "#" class = "chatting">채팅중</a>
    				</li>
					<li> <a href = "#" class = "bookmark">관심장소</a>
    				</li>
					<li> <a href = "#" class = "settings">설정</a>
    				</li>
				</ul>
			</nav>
